...
func _init_signal():
	...
	TechnologyManage.connect("selected_pool_to_propel",  Callable(self_var, "_selected_pool_to_propel"))
	TechnologyManage.connect("propel_to_propel",  Callable(self_var, "_propel_to_propel"))
	TechnologyManage.connect("propel_to_selected_pool", Callable(self_var, "_propel_to_selected_pool"))
	TechnologyManage.connect("selected_pool_update",  Callable(self_var,"_selected_pool_update"))
	TechnologyManage.connect("down", Callable(self_var, "_down"))
	TechnologyManage.connect("up",  Callable(self_var, "_up"))
	TechnologyManage.connect("start_round",  Callable(self_var, "_start_round"))
	TechnologyManage.connect("end_round",  Callable(self_var, "_end_round"))
	
	var TechnologyManage_var = TechnologyManage
	connect("to_propel",Callable(TechnologyManage_var,"to_propel"))
	connect("to_selected_pool",Callable(TechnologyManage_var,"to_selected_pool"))
