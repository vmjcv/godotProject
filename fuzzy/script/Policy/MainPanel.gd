...
var tree_slot = preload("res://scene/Policy/TreeSlot.tscn")
...
func _init_tree_slot():
	...
	for i in range(1,PolicyManage.all.tree_count+1):
		var tree_slot_node = tree_slot.instance()
		Tree_Grid.add_child(tree_slot_node)
		tree_slot_node.get_node("BasePanel/BaseContainer/Slot")
		pass
