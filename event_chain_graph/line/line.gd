...
var dotted_texture = preload("res://line/res/dotted_line.png")
var solid_texture = preload("res://line/res/solid_line.png")
var arrow_texture = preload("res://line/res/arrow.png")
...
func draw(type,begin_pos,end_pos,begin_color,end_color,time,info):
	...
	material.shader = load("res://line/res/line.shader")
	...
	if need_begin_arrow:
		...
		begin_arrow.material.shader = load("res://line/res/arrow.shader")
	...
	if need_end_arrow:
		...
		end_arrow.material.shader = load("res://line/res/arrow.shader")
